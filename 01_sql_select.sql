...
SELECT Name FROM world.city where CountryCode like "bfa";
#
# 5: Get both the name and district of the cities where the countrycode is "tto"
SELECT Name, district FROM world.city where CountryCode like "tto";
#
# 6: Get the name and district named as nm,dist from the cities where the countrycode is "arm"
SELECT name AS 'nm', district AS 'dist' FROM world.city WHERE countrycode LIKE('arm');
#
...
SELECT * from world.country where  IndepYear < 0;
#
#
